...
CLASS_TO_FILE = {
    ...
    "ModelRef": "backend/llm_config.py",
    "ModelSelection": "backend/llm_config.py",
    "LLMDefaults": "backend/llm_config.py",
    ...
    "GraphSchemaSnapshotReader": "backend/privacy_data_map.py",
    "WorkspaceAuditProjectionStream": "backend/privacy_data_map.py",
    "AppDeclarationSnapshotReader": "backend/privacy_data_map.py",
    "PrivacyDataMapService": "backend/privacy_data_map.py",
