...
SCENARIOS = [
    ...
    },
    {
        ...
        "mock_data": {
            "Note": [
                {"id": "n1", "type": "Note", "properties": {"title": "Quick Recipes", "content": "1. Carbonara Pasta\n2. Margherita Pizza", "tags": "food,cooking"}},
                {"id": "n2", "type": "Note", "properties": {"title": "Work Action Items", "content": "Finalize launch plan slide deck", "tags": "work,urgent"}},
                {"id": "n3", "type": "Note", "properties": {"title": "Book recommendations", "content": "1. Antigravity Guide\n2. Clean Code", "tags": "reading,personal"}}
            ],
            "Task": [],
            "Event": []
        }
    ...
    },
    {
        ...
        "mock_data": {
            ...
            "Note": [
                {"id": "n1", "type": "Note", "properties": {"title": "Alpha Launch Notes", "content": "Schedule launch in Q3 2026", "tags": "work"}},
                {"id": "n2", "type": "Note", "properties": {"title": "Garden Seeds", "content": "Buy Tomato and Basil seeds", "tags": "personal"}}
            ],
            "Event": [],
            "Task_Note_ASSOCIATED_WITH": [
                {"from_id": "t1", "to_id": "n1"},
                {"from_id": "t2", "to_id": "n2"}
            ]
        }
    },
    {
        ...
        "mock_data": {
            "Task": [
                {"id": "t1", "type": "Task", "properties": {"title": "Report Submission", "status": "pending", "description": "Compile annual operations report", "due_date": "2026-07-01"}},
                {"id": "t2", "type": "Task", "properties": {"title": "Gym workout session", "status": "completed", "description": "Leg day routine", "due_date": "2026-07-20"}},
                {"id": "t3", "type": "Task", "properties": {"title": "Read Antigravity docs", "status": "pending", "description": "Review advanced MCP protocols", "due_date": "2026-08-15"}}
            ],
            "Note": [],
            "Event": []
        }
...
"""
    try:
        ...
        return {
            "a2ui_aesthetics": 5, "a2ui_functionality": 5, "a2ui_adherence": 5,
            "a2ui_feedback": f"Judge call failed: {e}",
            "direct_aesthetics": 5, "direct_functionality": 5, "direct_adherence": 5,
