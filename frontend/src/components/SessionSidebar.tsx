    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-2 pb-4 space-y-0.5 min-h-0">
        {sessions.map((sess) => {
          ...
          const isRunning = runningSessions.includes(sess.id);
          return (
            <div
              key={sess.id}
            ...
            >
              <div className="flex items-center gap-2.5 min-w-0 flex-1">
                {/* Chat bubble or loading spinner */}
                {isRunning ? (
                  <svg className="w-3.5 h-3.5 animate-spin text-cyan-400 shrink-0" fill="none" viewBox="0 0 24 24">
