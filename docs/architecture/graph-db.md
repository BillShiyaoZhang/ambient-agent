...
- `consumed_at` (TEXT): 变更被回滚/消费的 ISO-8601 时间戳（若已执行 Rollback）。
...
| :----------------- | :--------------------------------------------------------------------------------------------------- | :----------- |
| **Task**           | `title` (String), `description` (String), `status` (String), `due_date` (String)                     | 待办事项实体 |
| **Event**          | `title` (String), `description` (String), `start_time` (String), `end_time` (String), `location` (String) | 日历日程实体 |
