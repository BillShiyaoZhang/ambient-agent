...
| `backend/schema_*` | Extracts Graph usage from controllers and performs schema diff, alignment, and verification |
...
| `SandboxWidget.tsx` | Compiles `controller.js`, injects the `ambient` API, and renders React Widgets |
